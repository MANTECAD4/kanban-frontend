...
import { TaskPriority, TaskTag, type TaskEntity } from "@/dtos/task.dto";
...
export const EditTaskDialog: FC<AddTaskDIalogProps> = ({ children, task }) => {
  const { register, control, errors, reset, handleSubmitForm } =
    useEditTask(task);
  return (
