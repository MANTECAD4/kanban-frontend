  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="h-8! bg-input/20 dark:bg-input/30">
        ...
        />
        <InputGroupAddon>
          <SearchIcon className="size-3.5 shrink-0 opacity-50 stroke-foreground" />
        </InputGroupAddon>
      </InputGroup>
    </div>
  );
...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        "overflow-hidden p-1 text-foreground **:[[cmdk-group-heading]]:px-2.5 **:[[cmdk-group-heading]]:py-1.5 **:[[cmdk-group-heading]]:text-xs **:[[cmdk-group-heading]]:font-medium **:[[cmdk-group-heading]]:text-foreground/60",
        className,
      )}
      {...props}
    />
